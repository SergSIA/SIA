...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "postgres_at_localhost";
		$data["connName"] = "postgres at localhost";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;localhost;postgres;admin;;postgres;;1;"; //currently unused

		$this->_connectionsIdByName["postgres at localhost"] = "postgres_at_localhost";
...
;
		...
		$connectionsData["postgres_at_localhost"] = $data;
