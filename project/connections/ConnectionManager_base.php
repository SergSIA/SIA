...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "postgres_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["public.advisor"] = "postgres_at_localhost";
		$connectionsIds["public.consulting"] = "postgres_at_localhost";
		$connectionsIds["public.customers"] = "postgres_at_localhost";
		$connectionsIds["public.document"] = "postgres_at_localhost";
		$connectionsIds["public.method_payment"] = "postgres_at_localhost";
		$connectionsIds["public.payment"] = "postgres_at_localhost";
		$connectionsIds["public.people"] = "postgres_at_localhost";
		$connectionsIds["public.role"] = "postgres_at_localhost";
		$connectionsIds["public.specialty"] = "postgres_at_localhost";
		$connectionsIds["public.status_consulting"] = "postgres_at_localhost";
		$connectionsIds["public.status_payment"] = "postgres_at_localhost";
		$connectionsIds["public.user"] = "postgres_at_localhost";
		$connectionsIds["public.people_user"] = "postgres_at_localhost";
		$connectionsIds["public.consulting_my"] = "postgres_at_localhost";
		$connectionsIds["public.country"] = "postgres_at_localhost";
		$connectionsIds["public.advisor_user"] = "postgres_at_localhost";
		$connectionsIds["public.consulting_my_advisor"] = "postgres_at_localhost";
		$connectionsIds["public.payment_my"] = "postgres_at_localhost";
