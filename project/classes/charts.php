...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("public.document" == $this->chrt_array['tables'][0])
			return true;
		if("public.method_payment" == $this->chrt_array['tables'][0])
			return true;
		if("public.payment" == $this->chrt_array['tables'][0])
			return true;
		if("public.people" == $this->chrt_array['tables'][0])
			return true;
		if("public.role" == $this->chrt_array['tables'][0])
			return true;
		if("public.specialty" == $this->chrt_array['tables'][0])
			return true;
		if("public.status_consulting" == $this->chrt_array['tables'][0])
			return true;
		if("public.status_payment" == $this->chrt_array['tables'][0])
			return true;
