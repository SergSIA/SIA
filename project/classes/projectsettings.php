...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("public.user", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "public.advisor" ] = array( "url" => "advisor", "type" => 0 );
	...
	$projectEntitiesReverse[ "document" ] = "public.document";
	$projectEntities[ "public.method_payment" ] = array( "url" => "method_payment", "type" => 0 );
	$projectEntitiesReverse[ "method_payment" ] = "public.method_payment";
	$projectEntities[ "public.payment" ] = array( "url" => "payment", "type" => 0 );
	$projectEntitiesReverse[ "payment" ] = "public.payment";
	$projectEntities[ "public.people" ] = array( "url" => "people", "type" => 0 );
	$projectEntitiesReverse[ "people" ] = "public.people";
	$projectEntities[ "public.role" ] = array( "url" => "role", "type" => 0 );
	$projectEntitiesReverse[ "role" ] = "public.role";
	$projectEntities[ "public.specialty" ] = array( "url" => "specialty", "type" => 0 );
	$projectEntitiesReverse[ "specialty" ] = "public.specialty";
	$projectEntities[ "public.status_consulting" ] = array( "url" => "status_consulting", "type" => 0 );
	$projectEntitiesReverse[ "status_consulting" ] = "public.status_consulting";
	$projectEntities[ "public.status_payment" ] = array( "url" => "status_payment", "type" => 0 );
