...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "postgres_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "advisor", "varname" => "postgres_at_localhost_public_advisor", "altvarname" => "advisor", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "consulting", "varname" => "postgres_at_localhost_public_consulting", "altvarname" => "consulting", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "country", "varname" => "postgres_at_localhost_public_country", "altvarname" => "country", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "customers", "varname" => "postgres_at_localhost_public_customers", "altvarname" => "customers", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "document", "varname" => "postgres_at_localhost_public_document", "altvarname" => "document", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "method_payment", "varname" => "postgres_at_localhost_public_method_payment", "altvarname" => "method_payment", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "payment", "varname" => "postgres_at_localhost_public_payment", "altvarname" => "payment", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "people", "varname" => "postgres_at_localhost_public_people", "altvarname" => "people", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "role", "varname" => "postgres_at_localhost_public_role", "altvarname" => "role", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "specialty", "varname" => "postgres_at_localhost_public_specialty", "altvarname" => "specialty", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "status_consulting", "varname" => "postgres_at_localhost_public_status_consulting", "altvarname" => "status_consulting", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "status_payment", "varname" => "postgres_at_localhost_public_status_payment", "altvarname" => "status_payment", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
			$dalTables[$conn->connId][] = array("name" => "user", "varname" => "postgres_at_localhost_public_user", "altvarname" => "user", "connId" => "postgres_at_localhost", "schema" => "public", "connName" => "postgres at localhost");
		}
	}
