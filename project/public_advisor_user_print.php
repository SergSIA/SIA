...
require_once("include/public_advisor_user_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.advisor_user" );
